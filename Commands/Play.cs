...
public class Play : ApplicationCommandModule<ApplicationCommandContext>
{
    ...
    public Play(IYouTubeDownloader downloader, IVoiceClientController voiceChannelController, ILogger<Play> logger)
    {
    ...
    public async Task Command(string url)
    {
        ...
        try
        {
            ...
            filePath = await _downloader.DownloadAsync(url);
